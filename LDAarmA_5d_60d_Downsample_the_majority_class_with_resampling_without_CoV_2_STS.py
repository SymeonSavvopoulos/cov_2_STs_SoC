...
if __name__ == "__main__":
    ...
    data=data.drop(columns=['CoV_2_STs'])
    ...
    mid_class=57-minority_class_size-majority_class_size
    ...
    for i in range(num_iterations):
        ...
        classes = ['Alive and well', 'Deceased', 'Alive with disease']
        ...
        # If you want an overall precision, you can use macro or micro average
       ...
       # Perform cross-validated predictions
        for train_index, test_index in cv.split(X, y):
           ...
           # Calculate precision per class for the current fold
           precision_fold = precision_score(y_test, y_pred, average=None)
           precision_per_fold.append(precision_fold)
       
       # Convert the list of precision arrays to a NumPy array
